...
const projects = [
  ...
  },
  {
    ...
    image: '/images/lca-pave.jpg',
  },
  {
    id: 'wind',
    title: 'Wind App',
    description: 'A lightweight wind resource viewer for custom location forecasts of selected wind models.',
    href: 'https://github.com/andrewsheerin/wind-app',
    cta: 'Github Repository',
    tags: ['Mapping UI', 'HRRR'],
    image: '/images/windapp-github.png',
  },

  {
    id: 'weatherwatch',
    title: 'WeatherWatch',
    description: 'Extract, visualize, and analyze historical and forecasted weather data for any location, with exportable summaries.',
    href: 'https://github.com/andrewsheerin/weatherwatch',
    cta: 'GitHub Repository',
    tags: ['Meteorology', 'Analytics'],
    image: '/images/weather-github.png',
  },
...

  {
    ...
    description: 'Extract custom topographic maps for any location and view and export high resolution 3D (STL) models.',
    href: 'https://github.com/andrewsheerin/topographic-maps',
    cta: 'GitHub Repository',
    tags: ['Topography', '3D Modeling'],
    image: '/images/topographic-github.png',
  },
